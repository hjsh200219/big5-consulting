...
이 파일은 이 저장소의 코드 작업 시 Claude Code에게 제공되는 지침입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) | 도메인 맵, 레이어 구조, 의존성 방향 |
| [docs/QUALITY.md](docs/QUALITY.md) | 도메인별 품질 등급 (A-F) |
